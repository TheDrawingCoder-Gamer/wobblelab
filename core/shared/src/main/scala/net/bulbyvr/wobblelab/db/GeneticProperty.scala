...
object GeneticProperty {
  ...
  case object EarCurlLeft extends PlainGeneticProperty("Ear Curl Left", 5), HasDefiniteBounds:
    def minBound: Float = 0f
    def maxBound: Float = 1f
  case object EarCurlRight extends PlainGeneticProperty("Ear Curl Right", 5), HasDefiniteBounds:
    def minBound: Float = 0f
    def maxBound: Float = 1f
